                            ...
                            <div key={personality.personality_id} className="relative group/card">
                                    ...
                                    <TiltCard className="h-full w-full aspect-[4/5]">
                                        <div
                                            className={cn(
                                                ...
                                                "bg-white/40 backdrop-blur-md border border-white/50 shadow-lg hover:shadow-2xl",
                                ...
                                {isOwner && (
                                    <button
                                        ...
                                        className="absolute top-3 left-3 z-[210] p-2 bg-white/20 hover:bg-white/40 text-white rounded-full backdrop-blur-md transition-all opacity-0 group-hover/card:opacity-100 transform hover:scale-110"
                                        title="Change Image"
                                    >
