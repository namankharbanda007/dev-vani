        ...
        <div className="flex flex-col items-center justify-center h-full w-full bg-gradient-to-b from-gray-900 to-black text-white relative overflow-hidden">
            ...
            <div className="z-10 flex flex-col items-center gap-8">
                ...
                {onEndCall && (
                    <button
                        onClick={onEndCall}
                        className="mt-8 flex items-center gap-3 bg-red-600 hover:bg-red-700 text-white px-8 py-4 rounded-full font-semibold transition-all duration-200 shadow-lg hover:scale-105"
                    >
