...
- Invoke this skill with prompts like `Use $geo to audit https://example.com`.
- Use files in `agents/prompts/` as reusable prompt guides when splitting work across sub-agents.
- Open folders under `skills/` on demand as bundled reference playbooks during the audit.
...
|----------|------|---------------|
| geo-ai-visibility | `agents/prompts/geo-ai-visibility.md` | GEO audit, citability, AI crawlers, llms.txt, brand mentions |
| geo-platform-analysis | `agents/prompts/geo-platform-analysis.md` | Platform-specific optimization (ChatGPT, Perplexity, Google AIO) |
| geo-technical | `agents/prompts/geo-technical.md` | Technical SEO, Core Web Vitals, crawlability, indexability |
| geo-content | `agents/prompts/geo-content.md` | Content quality, E-E-A-T, readability, AI content detection |
| geo-schema | `agents/prompts/geo-schema.md` | Schema markup detection, validation, generation |
...
|-------|------|-------------|
| geo-ai-visibility | `agents/prompts/geo-ai-visibility.md` | geo-citability, geo-crawlers, geo-llmstxt, geo-brand-mentions |
| geo-platform-analysis | `agents/prompts/geo-platform-analysis.md` | geo-platform-optimizer |
| geo-technical | `agents/prompts/geo-technical.md` | geo-technical |
| geo-content | `agents/prompts/geo-content.md` | geo-content |
| geo-schema | `agents/prompts/geo-schema.md` | geo-schema |
...
3. Execute the PDF generator: `python scripts/generate_pdf_report.py data.json GEO-REPORT.pdf`
